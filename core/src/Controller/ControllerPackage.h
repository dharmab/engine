...
public:
     ...
     */
    ControllerPackage(std::shared_ptr<Model::IGraphicsManager> graphicsManager, std::shared_ptr<Model::IInputManager> inputManager, std::shared_ptr<SoundManager> soundManager);
